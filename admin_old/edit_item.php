                    ...
                    <?php
					  ...
					  ?>
						...
						<div class="form">
								...
								<p>
									<span class="req">max 100 symbols</span>
									<label>Item Source <span>(Required Field)</span></label>
									<input type="text" class="field size1" name="mediaSource"  value="<?php echo $xml_data->singlepost[$item]->mediaSource; ?>" />
								</p>

								<p>
									<span class="req">max 100 symbols</span>
									<label>Thumb Url <span>(Required Field)</span></label>
									<input type="text" class="field size1" name="thumbUrl"  value="<?php echo $xml_data->singlepost[$item]->thumbUrl; ?>" />
								</p>

								<p>
									<span class="req">max 100 symbols</span>
									<label>Change Image <span>(If You Want To Change)</span></label>
